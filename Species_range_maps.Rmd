...
pacman::p_load(spocc, sf, mapview, lubridate, dplyr, raster,
               sf, scrubr, stringr, sp, rgeos, dismo, broom)
```
...
In this part, we will extract extent of suitable habitat by filtering extent of occurence (EOO) within min-max values of a raster variable. In future multiple rasters + categorical variables.
